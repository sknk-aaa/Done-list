/**
 * To Done — Design Tokens (single source of truth)
 * Generated from the approved HTML mock. Drop into your Expo app and reference
 * everywhere instead of hard-coding values. Keeps RN output pixel-faithful.
 *
 * NOTE: All sizes are in points (RN's default unit == iOS pt == CSS px in the mock).
 */
...
export const font = {
  // The mock uses the system stack: SF Pro (Latin) + Hiragino Sans (JP),
  // which is RN's default on iOS. Do NOT bundle a custom font unless asked.
 ...
 * Helper: shadow(level) spreads into a style object.
 */
export const shadow = {
  card: {
  ...
  fab: {
    shadowColor: '#48C1A8', shadowOpacity: 0.45, shadowRadius: 12,
    shadowOffset: { width: 0, height: 8 }, elevation: 6,
  },
  sheet: { // sheets cast an upward shadow
    shadowColor: '#000', shadowOpacity: 0.12, shadowRadius: 24,
    shadowOffset: { width: 0, height: -10 }, elevation: 16,
  },
  popover: {
    shadowColor: '#000', shadowOpacity: 0.20, shadowRadius: 22,
...
export const size = {
  statusBarH: 54,         // includes notch area; use SafeAreaView in RN instead
  headerPadTop: 6,
...
/** Motion. */
export const motion = {
  screenSlide: { duration: 340, easing: 'cubic-bezier(0.4,0,0.2,1)' }, // tab/sheet/drawer
