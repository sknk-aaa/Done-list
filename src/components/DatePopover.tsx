...
const makeStyles = (c: Colors) => StyleSheet.create({
  ...
  card: { position: 'absolute', left: 18, width: 340, backgroundColor: c.bg, borderRadius: radius.cardL, padding: 16 },
  ...
  dow: { width: `${100 / 7}%`, textAlign: 'center', fontSize: 13, color: c.muted, paddingBottom: 8 },
  sun: { color: c.red },
