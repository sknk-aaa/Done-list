...
const makeStyles = (c: Colors) =>
  StyleSheet.create({
    ...
    selCircle: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, borderRadius: 15, backgroundColor: c.teal, opacity: 0.4 },
    ...
    numSel: { color: c.teal, fontWeight: '700' },
    ...
    badgeText: { fontSize: 9, fontWeight: '700', color: c.teal },
  });
